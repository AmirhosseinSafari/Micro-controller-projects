...
; 0000 0079 UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 007A UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(24)
	OUT  0xA,R30
; 0000 007B UCSRC=(1<<URSEL) | (0<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (0<<UCPOL);
	LDI  R30,LOW(134)
	OUT  0x20,R30
...
; 0000 00BF       while(1){
_0xC:
; 0000 00C0         input_from_left = getchar();
	CALL _getchar
	MOV  R5,R30
; 0000 00C1         lcd_putchar(input_from_left);
	MOV  R26,R5
	RCALL _lcd_putchar
; 0000 00C2         counter += 1;
	__ADDWRN 16,17,1
; 0000 00C3         if(counter >= 4 ){
	__CPWRN 16,17,4
	BRLT _0xF
; 0000 00C4            counter = 0;
	__GETWRN 16,17,0
