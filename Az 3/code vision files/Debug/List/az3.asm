...
; 0000 008C             //PORTA=0b00000000;
; 0000 008D             //PORTB=0b11111111;
; 0000 008E             int i=0;
; 0000 008F             for(i=0;i<100;i++){
	SBIW R28,2
	LDI  R30,LOW(0)
	ST   Y,R30
	STD  Y+1,R30
...
_0x7:
	...
	BRGE _0x8
; 0000 0090             //A
; 0000 0091             PORTA=0b00000000;
	RCALL SUBOPT_0x0
; 0000 0092             PORTB=0b11111111;
; 0000 0093 
; 0000 0094             PORTA=0b11111000;
	LDI  R30,LOW(248)
	OUT  0x1B,R30
; 0000 0095             PORTB=0b11010111;
	LDI  R30,LOW(215)
	RCALL SUBOPT_0x1
; 0000 0096 
; 0000 0097             delay_ms(10);
; 0000 0098 
; 0000 0099             PORTA=0b00000000;
	RCALL SUBOPT_0x0
; 0000 009A             PORTB=0b11111111;
; 0000 009B 
; 0000 009C             PORTA=0b00100100;
	LDI  R30,LOW(36)
	OUT  0x1B,R30
; 0000 009D             PORTB=0b11101111;
	LDI  R30,LOW(239)
	RCALL SUBOPT_0x1
; 0000 009E 
...
; 0000 00A1 
; 0000 00A2             //empty
; 0000 00A3             PORTA=0b00000000;
	RCALL SUBOPT_0x0
; 0000 00A4             PORTB=0b11111111;
; 0000 00A5 
...
_0xA:
	...
	BRGE _0xB
; 0000 00A9             //S
; 0000 00AA             PORTA=0b00000000;
	RCALL SUBOPT_0x0
; 0000 00AB             PORTB=0b11111111;
; 0000 00AC 
; 0000 00AD             PORTA=0b10101000;
	LDI  R30,LOW(168)
	OUT  0x1B,R30
; 0000 00AE             PORTB=0b11000111;
	LDI  R30,LOW(199)
	RCALL SUBOPT_0x1
; 0000 00AF 
; 0000 00B0             delay_ms(10);
; 0000 00B1 
; 0000 00B2             PORTA=0b00000000;
	RCALL SUBOPT_0x0
; 0000 00B3             PORTB=0b11111111;
; 0000 00B4 
; 0000 00B5             PORTA=0b01000000;
	LDI  R30,LOW(64)
	OUT  0x1B,R30
; 0000 00B6             PORTB=0b11110111;
	LDI  R30,LOW(247)
	RCALL SUBOPT_0x1
; 0000 00B7 
; 0000 00B8             delay_ms(10);
; 0000 00B9 
; 0000 00BA             PORTA=0b00000000;
	RCALL SUBOPT_0x0
; 0000 00BB             PORTB=0b11111111;
; 0000 00BC 
; 0000 00BD             PORTA=0b00010000;
	LDI  R30,LOW(16)
	OUT  0x1B,R30
; 0000 00BE             PORTB=0b11011111;
	LDI  R30,LOW(223)
	RCALL SUBOPT_0x1
; 0000 00BF 
...
; 0000 00C2 
; 0000 00C3             //empty
; 0000 00C4             PORTA=0b00000000;
	RCALL SUBOPT_0x0
; 0000 00C5             PORTB=0b11111111;
; 0000 00C6 
