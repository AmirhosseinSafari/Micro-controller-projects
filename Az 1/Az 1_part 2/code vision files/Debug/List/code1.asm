...
; 0000 0084 TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 0085 
; 0000 0086 DDRA = 0x0000;
	OUT  0x1A,R30
; 0000 0087 DDRC = 0xffff;
	LDI  R30,LOW(255)
	OUT  0x14,R30
; 0000 0088 
; 0000 0089 PORTC = 0x0000;
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 008A 
; 0000 008B while (1==1)
...
; 0000 008F         if( PINA.0 == 0 && PINA.1 == 0 ){
	SBIC 0x19,0
	RJMP _0x7
	SBIS 0x19,1
	RJMP _0x8
_0x7:
	RJMP _0x6
_0x8:
; 0000 0090                 PORTC = 0x0000;
	LDI  R30,LOW(0)
	RJMP _0x16
; 0000 0091         }else if( PINA.0 == 0 && PINA.1 == 1 ){
_0x6:
	SBIC 0x19,0
	RJMP _0xB
	SBIC 0x19,1
...
; 0000 0092                 PORTC = 0xa;
	LDI  R30,LOW(10)
	RJMP _0x16
; 0000 0093         }else if( PINA.0 == 1 && PINA.1 == 0 ){
_0xA:
	SBIS 0x19,0
	RJMP _0xF
	SBIS 0x19,1
...
_0xF:
	RJMP _0xE
_0x10:
; 0000 0094                 PORTC = ~PORTC;
	IN   R30,0x15
	COM  R30
	RJMP _0x16
; 0000 0095         }else if( PINA.0 == 1 && PINA.1 == 1 ){
_0xE:
	SBIS 0x19,0
	RJMP _0x13
	SBIC 0x19,1
